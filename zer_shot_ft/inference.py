...
def main():
    ...
    parser.add_argument("--reference-text", type=str, default="""وضيفنا اليوم دكتور عبد السلام البلوشي صاحب أضخم إنجاز عالمي لشهادتها الشرق الأوسط وأفريقيا من الإمارات. وهذا الإنجاز هو إقامة أول عملية جراحية للعمود الفقري عن طريق الروبوت.""", help="Reference text matching the audio")
    ...
    parser.add_argument("--output", type=str, default="../output_emr_fm.wav", help="Path to save output audio")
